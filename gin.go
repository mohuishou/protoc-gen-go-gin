...
const (
	...
	transportPackage = protogen.GoImportPath("github.com/gin-gonic/gin")
...
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	...
	g.P("// is compatible with the pango package it is being compiled against.")
	g.P("// ", contextPackage.Ident(""), metadataPkg.Ident(""))
	g.P("//", transportPackage.Ident(""), errPkg.Ident(""))
	g.P()
